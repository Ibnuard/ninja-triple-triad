    ...
    >
      ...
      <div
        className={cn(
          ...
          "hidden md:block", // Hide on mobile for both players
      ...
      <div
        className={cn(
          "flex items-center justify-center p-2 md:p-6 rounded-2xl transition-all duration-500 relative w-full",
          orientation === "vertical"
            ? "flex-col gap-3 h-full"
            : "flex-row gap-1 md:gap-6",
          ...
          !isMyTurn && "scale-90 md:scale-100 origin-center", // Less aggressive shrink
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  orientation === "vertical" &&
                    "hover:z-10 hover:scale-110 hover:!my-2 md:hover:!my-4 cursor-pointer",
              ...
              >
                {isHidden ? (
                  ...
                  <div className="w-[14vw] h-[20vw] max-w-[80px] max-h-[110px] md:w-20 md:h-28 rounded-lg border border-white/10 shadow-lg relative overflow-hidden group">
                    <div className="absolute inset-0 bg-linear-to-br from-gray-800 to-gray-950" />
                    <div className="absolute inset-0 opacity-20 bg-[url('https://www.transparenttextures.com/patterns/carbon-fibre.png')]" />
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="w-6 h-6 md:w-8 md:h-8 rounded-full border border-white/10 flex items-center justify-center">
