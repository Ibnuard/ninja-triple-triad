...
export default function LobbyPage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center relative p-4">
      ...
      >
        <h2 className="text-3xl font-bold mb-8 text-center uppercase tracking-widest text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-red-600">
          Multiplayer Lobby
        </h2>
        ...
        <div className="space-y-6">
          ...
          <div className="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-red-500/50 transition-colors group">
            <h3 className="text-xl font-bold mb-2">Create New Dojo</h3>
            <p className="text-sm text-gray-400 mb-4">
              Start a new match and invite a rival.
            </p>
            <button
              onClick={handleCreateRoom}
              disabled={isCreating}
              className="w-full py-3 bg-red-600 hover:bg-red-700 rounded-lg font-bold uppercase tracking-wider transition-all"
            >
          ...
          <div className="p-6 bg-white/5 rounded-xl border border-white/5 hover:border-blue-500/50 transition-colors">
            <h3 className="text-xl font-bold mb-2">Join Existing Dojo</h3>
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 bg-black/50 border border-white/10 rounded-lg px-4 py-3 font-mono text-center tracking-widest focus:outline-none focus:border-blue-500 uppercase"
              />
              <button
